...
//       'comments': 45,
//       'isLiked': false,
//       'videoUrl': 'https://static.fastpix.io/sample.mp4',
...
class ReelsController extends GetxController {
  ...
  //
  //   videoController =
  //       VideoPlayerController.network(reels[index].videoUrl);
  //
